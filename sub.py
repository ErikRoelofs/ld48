...
from consts import *
from subsystem import SubSystem, PowerPlant, Battery, Heat, Audio, Engine, Antenna, EvasiveEngine, Sonar, ScienceStation
import random
...
class Sub:
    def __init__(self, oned, world, sonar):
        ...
        self.system = [
            ...
            ScienceStation(oned, (0, 0, 255), (0, 0, 150), (0, 0, 0), 400),
